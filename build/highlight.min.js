...
r(e)&&(this.buffer+="</i>")}value(){return this.buffer}span(e){
this.buffer+=`<i class='${e}'>`}}class l{constructor(){this.rootNode={
...
;e.classList.add("pre-hl"),e.classList.add("language-"+a)
